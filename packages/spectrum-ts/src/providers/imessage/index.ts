// Compat shim — `spectrum-ts/providers/imessage` (the v4 import path).
//
// The provider lives in `@photon-ai/spectrum-provider-imessage` since v5; this
...
export * from "@photon-ai/spectrum-provider-imessage";
