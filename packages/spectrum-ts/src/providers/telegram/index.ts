// Compat shim — `spectrum-ts/providers/telegram` (the v4 import path).
//
// The provider lives in `@photon-ai/spectrum-provider-telegram` since v5; this
...
export * from "@photon-ai/spectrum-provider-telegram";
