// Compat shim — `spectrum-ts/providers/terminal` (the v4 import path).
//
// The provider lives in `@photon-ai/spectrum-provider-terminal` since v5; this
...
export * from "@photon-ai/spectrum-provider-terminal";
