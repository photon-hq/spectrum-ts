...
import * as discordPkg from "@spectrum-ts/discord";
...
import * as discordShim from "@/providers/discord/index";
...
const cases = [
  ["discord", discordShim, discordPkg],
...
describe("spectrum-ts/providers/* shims", () => {
  ...
  it("barrel re-exports the six provider consts by their v4 names", () => {
    expect(barrel.discord).toBe(discordPkg.discord);
