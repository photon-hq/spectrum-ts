...
import * as chatSdkPkg from "@spectrum-ts/chat-sdk";
...
import * as chatSdkShim from "@/providers/chat-sdk/index";
...
const cases = [
  ["chat-sdk", chatSdkShim, chatSdkPkg],
...
describe("spectrum-ts/providers/* shims", () => {
  ...
  it("barrel re-exports the provider consts by their v4 names", () => {
    expect(barrel.chatSDK).toBe(chatSdkPkg.chatSDK);
